...
{
    internal class ObjectModelTrackSequencesSimple<T> where T : IByteSerializable
    {
        public List<ObjectModelTrackSequenceTimestampShorts> Timestamps = new List<ObjectModelTrackSequenceTimestampShorts>();
        ...
        {
            Timestamps.Add(new ObjectModelTrackSequenceTimestampShorts());
            Values.Add(new ObjectModelTrackSequenceValues<T>());
            return Timestamps.Count - 1;
        }

        public void AddValueToSequence(int sequenceID, UInt16 timestamp, T value)
        {
        ...
        public void AddValueToLastSequence(UInt16 timestamp, T value)
        {
        ...
        public void ReplicateFirstValueToEnd(int sequenceID, UInt16 timestamp)
        {
