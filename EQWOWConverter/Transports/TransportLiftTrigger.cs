...
namespace EQWOWConverter.Transports
{
    internal class TransportLiftTrigger
    {
        ...
        public ActiveDoodadAnimType AnimationType = ActiveDoodadAnimType.OnActivateSlideUpDownWithMod;
        ...
        private static void PopulateTransportLiftTriggerList()
        {
            ...
            foreach (Dictionary<string, string> columns in rows)
            {
                ...
                {
                    case "up_down": curLiftTrigger.AnimationType = ActiveDoodadAnimType.OnActivateSlideUpDownWithMod; break;
                    case "rot_z": curLiftTrigger.AnimationType = ActiveDoodadAnimType.OnActivateRotateAroundZClockwiseHalf; break;
