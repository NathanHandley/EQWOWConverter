        ...
        public float GetVolume()
        {
            if (Type == SoundType.GameObject || Type == SoundType.ZoneAmbience)
            {
                ...
                switch (AudioFileNameNoExt.ToLower().Trim())
                {
                    ...
                    case "slmeloop":    volume = 1f;            break; // TBD Test: Runnyeye
                    ...
                    case "spinnrlp":    volume = 0.36f;         break; // Test: Oggok, Steamfont (0.8912509)
                    ...
                    case "wfall_lg":    volume = 0.8912509f;    break; // Test: Akanon
                    case "wfall_md":    volume = 0.8912509f;    break; // Test: Akanon, Erudnext
                    case "wind_lp1":    volume = 1f;            break; // TBD
                    ...
                    case "wtr_pool":    volume = 0.8912509f;    break; // Test: Akanon, Cazic, Commons
                    default:
                        {
                            Logger.WriteDetail("No static defined volume for sound with file name '" + AudioFileNameNoExt + "'");
                        } break;
                }
                return volume;
            }
