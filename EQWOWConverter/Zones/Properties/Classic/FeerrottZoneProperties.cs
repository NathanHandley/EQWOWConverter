...
namespace EQWOWConverter.Zones.Properties
{
    internal class FeerrottZoneProperties : ZoneProperties
    {
        public FeerrottZoneProperties()
        {
            ...
            AddLiquidPlaneZLevel(LiquidType.Water, "d_sw1", 2104.413330f, 2316.766602f, 541.289795f, 976.981201f, -29.031210f, 300f);
            AddLiquidPlaneZLevel(LiquidType.Water, "d_sw1", 542f, 1206.450073f, 226.887222f, 633.791870f, -29.031210f, 300f);
            AddLiquidPlaneZLevel(LiquidType.Water, "d_sw1", 543.668091f, 1291.754883f, 440.032959f, 1204.328369f, -29.031210f, 300f);
            AddLiquidPlaneZLevel(LiquidType.Water, "d_sw1", 230.289062f, 982.076294f, -109.899048f, 285.150513f, -29.031210f, 300f);
            AddLiquidPlaneZLevel(LiquidType.Water, "d_sw1", -108.000000f, 938.000000f, -2141.682129f, 565.552185f, -29.031210f, 300f); // West Fork
            AddLiquidPlaneZLevel(LiquidType.Water, "d_sw1", 4.483450f, 299.117706f, -527.667542f, -29.172649f, -29.031210f, 300f); // East Fork
            AddLiquidPlaneZLevel(LiquidType.Water, "d_sw1", -97.385689f, 488.924164f, -294.640381f, 284.096161f, -29.031210f, 300f);
