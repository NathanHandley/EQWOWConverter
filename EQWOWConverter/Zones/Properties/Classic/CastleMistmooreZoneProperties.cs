...
namespace EQWOWConverter.Zones.Properties
{
    internal class CastleMistmooreZoneProperties : ZoneProperties
    {
        public CastleMistmooreZoneProperties()
        {
            ...
            AddLiquidPlaneZLevel(LiquidType.Water, "t50_w1", 2.439530f, 95.290939f, -14.319680f, 84.488243f, -194.937485f, 5f); // Courtyard Pool Base 1
            AddLiquidPlaneZLevel(LiquidType.Water, "t50_w1", 0.899840f, 96.857147f, -12.823690f, 83.049080f, -194.937485f, 5f); // Courtyard Pool Base 2
            AddLiquidPlaneZLevel(LiquidType.Water, "t50_w1", -0.571870f, 98.305656f, -11.297530f, 81.506592f, -194.937485f, 5f); // Courtyard Pool Base 3
            AddLiquidPlaneZLevel(LiquidType.Water, "t50_w1", -2.049700f, 90.969017f, -9.905360f, 89.007263f, -189.882553f, 10f); // Courtyard Pool Fountain N and S
