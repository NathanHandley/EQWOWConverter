...
namespace EQWOWConverter.Zones.Properties
{
    internal class NorthFreeportZoneProperties : ZoneProperties
    {
        public NorthFreeportZoneProperties() : base()
        {
            ...
            AddLiquidPlaneZLevel(LiquidType.Water, "t50_w1", -15.130130f, 362.879608f, -41.071400f, 336.649323f, -12.999990f, 10f); // Outside Temple of Marr
            AddLiquidPlaneZLevel(LiquidType.Water, "t50_w1", 142.245224f, 363.727295f, 59.144009f, 336.929474f, -30.999981f, 10f); // Inside Temple of Marr, bottom part of fountain
            AddLiquidPlaneZLevel(LiquidType.Water, "t50_w1", 151.630280f, 360.173492f, 142.563675f, 339.751465f, -25.000000f, 10f); // Inside Temple of Marr, top part of fountain 
            AddLiquidPlaneZLevel(LiquidType.Water, "t50_w1", 144.363464f, 358.713867f, 141.006744f, 341.559204f, -25.000000f, 10f); // Inside Temple of Marr, top part of fountain 
            AddLiquidPlaneZLevel(LiquidType.Water, "t50_w1", 142.370056f, 356.783447f, 138.959152f, 343.221436f, -25.000000f, 10f); // Inside Temple of Marr, top part of fountain + fall
            AddLiquidPlaneZLevel(LiquidType.Water, "t50_w1", 548.706177f, 660.475281f, 495.713226f, 538.462585f, -20.999960f, 40f); // NW corner channel
