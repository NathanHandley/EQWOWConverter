...
namespace EQWOWConverter.Zones.Properties
{
    internal class WarrensZoneProperties : ZoneProperties
    {
        public WarrensZoneProperties()
        {
            ...
            AddLiquidPlaneZLevel(LiquidType.Water, "t50_w1", 617.556641f, 317.333496f, 545.656250f, 247.194733f, -114.968719f, 100f); // Pool
            AddLiquidPlaneZLevel(LiquidType.Water, "t50_w1", 866.417175f, -456.959717f, 712.530212f, -537.631897f, -80.968719f, 100f); // Channel, north top
            AddLiquidPlaneZLevel(LiquidType.Water, "t50_w1", 596.772156f, -537.912302f, 545.353271f, -589.962708f, -80.968719f, 100f); // Channel, north bottom (east protusion)
