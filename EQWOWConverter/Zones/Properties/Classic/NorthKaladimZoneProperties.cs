...
namespace EQWOWConverter.Zones.Properties
{
    internal class NorthKaladimZoneProperties : ZoneProperties
    {
        public NorthKaladimZoneProperties() : base()
        {
            ...
            AddZoneArea("Gemstone Mine", 795.009949f, 457.298615f, -38.483971f, 520.949097f, 140.156342f, -133.599564f);
            if (Configuration.CONFIG_AUDIO_USE_ALTERNATE_TRACKS == true)
                AddZoneArea("Temple of Brell Serilis", 1483.537109f, 206.665359f, 92.547607f, 657.100952f, 67.384972f, -2.300760f, "kaladima-02", "kaladima-02");
            else
                AddZoneArea("Temple of Brell Serilis", 1483.537109f, 206.665359f, 92.547607f, 657.100952f, 67.384972f, -2.300760f);
            AddZoneArea("Greybloom Farms", 700.961914f, -55.230789f, 58.052711f, 569.156677f, -215.507767f, -37.635891f);
            AddZoneArea("Everhot Forge", 406.560242f, -144.992920f, 52.823269f, 340.473755f, -212.804214f, -5.368430f);
