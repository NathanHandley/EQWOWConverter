...
namespace EQWOWConverter.Zones.Properties
{
    internal class TempleOfSolusekRoZoneProperties : ZoneProperties
    {
        public TempleOfSolusekRoZoneProperties() : base()
        {
            ...
            AddQuadrilateralLiquidShapeZLevel(ZoneLiquidType.Magma, "d_lava001", 505.731720f, -42.152409f, 499.536438f, -38.081902f, 484.816589f, -50.759651f, 495.153717f, -62.718128f, 12.000010f, 15f, 2000f, 2000f, -2000f, -2000f, 0.4f); // Top area, east fall
            ...
            AddQuadrilateralLiquidShapeZLevel(ZoneLiquidType.Magma, "d_m0002", 484.653290f, 37.431648f, 479.832001f, 45.032742f, 475.742035f, 34.063629f, 475.808105f, 32.345268f, 8.000030f, 14.5f, 2000f, 2000f, -2000f, -2000f, 0.4f); // Top area, west 1st level up
            ...
            AddQuadrilateralLiquidShapeZLevel(ZoneLiquidType.Magma, "d_m0002", 503.979767f, 59.812340f, 494.726990f, 70.472641f, 485.481201f, 63.863422f, 499.118988f, 52.208672f, 12.000010f, 50f, 2000f, 2000f, -2000f, -2000f, 0.5f); // Top area, west 2nd level lava fall
            ...
            AddOctagonLiquidShape(ZoneLiquidType.Magma, "d_m0002", 489.820374f, 476.808990f, 13.012480f, -0.013940f, 9.020610f, 3.978410f, 9.020610f, 3.978410f, 485.784668f, 480.833710f, 485.784668f, 480.833710f, 5.000010f, 90f);
