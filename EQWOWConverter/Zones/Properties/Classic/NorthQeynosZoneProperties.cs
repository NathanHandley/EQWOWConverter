...
namespace EQWOWConverter.Zones.Properties
{
    internal class NorthQeynosZoneProperties : ZoneProperties
    {
        public NorthQeynosZoneProperties() : base()
        {
            ...
            AddZoneAreaBox("Qeynos Underbelly", 239.557587f, 269.499146f, -1.580140f, -4.889460f, 7.821560f, -74.407204f);
            AddZoneAreaBox("Qeynos Underbelly", 156.623184f, 295.676483f, -1.580140f, -4.889460f, 7.821560f, -74.407204f);

            AddChildZoneArea("Reflecting Pond", "North Qeynos");
            AddZoneAreaBox("Reflecting Pond", 225.163986f, 392.702484f, -4.225650f, 167.449249f, 279.318115f, -500f);

            AddChildZoneArea("The Cobbler", "North Qeynos");
            AddZoneAreaBox("The Cobbler", -53.441002f, 27.927370f, 100f, -83.798622f, -27.942450f, -1.547380f);
            AddZoneAreaBox("The Cobbler", -53.441002f, 1.972830f, 100f, -97.868210f, -27.942450f, -1.547380f);

            AddChildZoneArea("Order of the Silent Fist", "North Qeynos");
            AddZoneAreaBox("Order of the Silent Fist", 387.976227f, 417.667633f, 100f, 252.011978f, 245.211823f, -1.547380f);

            AddZoneArea("Crows Pub and Casino");
            AddZoneAreaBox("Crows Pub and Casino", 125.749100f, 377.678131f, 100f, 28.148331f, 308.012634f, -100f);
            AddZoneAreaBox("Crows Pub and Casino", 69.783287f, 377.678131f, 100f, 28.148331f, 280.053406f, -100f);

            AddChildZoneArea("Sneed Galliway's Trading Post", "North Qeynos");
            AddZoneAreaBox("Sneed Galliway's Trading Post", 153.636826f, 279.677948f, 100f, 98.028473f, 182.072983f, -1.547380f);
            AddZoneAreaBox("Sneed Galliway's Trading Post", 153.636826f, 223.864426f, 100f, 84.053848f, 182.072983f, -1.547380f);

            AddChildZoneArea("Ironforge Estate", "North Qeynos");
            AddZoneAreaBox("Ironforge Estate", 157.945709f, 49.223141f, 100f, 40.169628f, -28.157061f, -1.547380f);
            AddZoneAreaBox("Ironforge Estate", 157.945709f, 49.223141f, 100f, 69.815872f, -105.258453f, -1.547380f);
            AddZoneAreaBox("Ironforge Estate", 157.945709f, 97.868721f, 100f, 14.391950f, 42.199970f, -1.547380f);
            AddZoneAreaBox("Ironforge Estate", 144.467056f, 128.472595f, 100f, 35.919418f, 42.199970f, -1.547380f);
            ...
            AddZoneAreaBox("Temple of Life", 16.545980f, -107.728653f, 100f, -263.607483f, -760.173279f, -400);
