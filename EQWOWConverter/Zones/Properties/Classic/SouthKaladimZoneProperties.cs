...
namespace EQWOWConverter.Zones.Properties
{
    internal class SouthKaladimZoneProperties : ZoneProperties
    {
        public SouthKaladimZoneProperties() : base()
        {
            ...
            AddZoneArea("Main Gate", 146.431183f, 62.509140f, 70.454086f, -109.933128f, -110.416473f, -10.129540f, "kaladima-00", "kaladima-00", Configuration.CONFIG_AUDIO_MUSIC_DEFAULT_VOLUME, "", "", Configuration.CONFIG_AUDIO_AMBIENT_SOUND_DEFAULT_VOLUME, false);
            AddZoneArea("Pub Kal", 118.635437f, 250.987381f, 20.040649f, 72.985977f, 228.588013f, -2.086410f, "kaladima-04", "kaladima-04");
            AddZoneArea("Pub Kal", 94.753662f, 250.987381f, 20.040649f, 73.307312f, 205.085403f, -2.086410f, "kaladima-04", "kaladima-04");
            AddZoneArea("Irontoe's Eats", 202.718903f, 334.681396f, 32.399288f, 169.567993f, 290.871521f, -5.210800f, "kaladima-05", "kaladima-05");
            AddZoneArea("Tanned Assets", 179.209122f, 393.627869f, 56.327728f, 156.926529f, 361.014832f, -4.393900f);
            AddZoneArea("Redfist's Metal", 142.030411f, 406.263794f, 33.101601f, 119.972191f, 360.936554f, -3.876520f);
