    ...
    internal class DreadlandsZoneProperties : ZoneProperties
    {
        public DreadlandsZoneProperties() : base()
        {
            ...
            AddZoneLineBox("karnor", -81.997353f, 341.945251f, 0f, ZoneLineOrientationType.East,
                521.480408f, -1985.006226f, 65.162521f, 477.249451f, -2037.955078f, 18.468460f); // Karnor South entry
            AddZoneLineBox("firiona", 240.615234f, 6047.389648f, -82.966827f, ZoneLineOrientationType.South,
                315.327850f, -6036.449707f, 184.674255f, 269.808441f, -6161.772949f, 129.150375f);
            AddZoneLineBox("frontiermtns", -3835.836182f, -3291.410645f, -350.405426f, ZoneLineOrientationType.East,
                2417.939941f, -3442.503906f, 183.325562f, 2262.425049f, -3551.589355f, 126.868477f);
        }
    }
}
