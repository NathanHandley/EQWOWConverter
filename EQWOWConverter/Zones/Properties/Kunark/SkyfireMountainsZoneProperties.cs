...
namespace EQWOWConverter.Zones.Properties
{
    internal class SkyfireMountainsZoneProperties : ZoneProperties
    {
        ...
        {
            // AddZoneLineBox("burningwood", 5087.0146f, 1740.0859f, -163.56395f, ZoneLineOrientationType.South, -5623.817f, 1910.7054f, -56.840195f, -5703.1704f, 1580.5497f, -164.28036f);
            // AddZoneLineBox("overthere", -988.312561f, 4201.076660f, 95.625771f, ZoneLineOrientationType.East, -1063.791504f, -4348.341309f, 108.087097f, -1129.249390f, -4404.932129f, 26.440439f, "North");
            // AddZoneLineBox("overthere", -1097.624146f, 4200.114258f, 95.625771f, ZoneLineOrientationType.East, -1161.999390f, -4349.868164f, 108.087097f, -1231.563721f, -4408.827148f, 26.019140f, "South");
            ...
            // AddLiquidPlane(ZoneLiquidType.Magma, "d_lava001", 4122.767578f, 2848.519287f, 4105.233887f, 2812.736328f, -127.543694f, -135.220276f, ZoneLiquidSlantType.SouthHighNorthLow, 250f); // North NorthWest river, climbing south to dragon head
            ...
            // AddLiquidPlaneZLevel(ZoneLiquidType.Magma, "d_lava001", 4526.216309f, 2862.261963f, 4088.063477f, 2610.507080f, -135.218597f, 200f); // North NorthWest river under the south climb to dragon head, flat

            
            // AddLiquidPlane(ZoneLiquidType.Magma, "d_lava001", 4590.627930f, 2561.269043f, 4552.329102f, 2549.357178f, -176.390427f, -184.223267f, ZoneLiquidSlantType.WestHighEastLow, 250f); // North Northwest river, climb between highest flat and middle flat
            ...
            // AddLiquidPlaneZLevel(ZoneLiquidType.Magma, "d_lava001", 4799.291016f, 2591.093994f, 4583.361328f, 1992.584595f, -184.187180f, 250f); // North Northwest river, middle flat

            
            // AddLiquidPlane(ZoneLiquidType.Magma, "d_lava001", 4754.747559f, 1955.175171f, 4706.935059f, 1941.257080f, -190.411255f, -199.722000f, ZoneLiquidSlantType.WestHighEastLow, 250f); // North Northwest river, climb between lowest and middle flat
            ...
            // AddLiquidPlaneZLevel(ZoneLiquidType.Magma, "d_lava001", 4759.243164f, 1958.178589f, 3103.476562f, 936.244263f, -199.718567f, 250f); // North Northwest river, lowest flat (connects at junction)

            
            // AddLiquidPlaneZLevel(ZoneLiquidType.Magma, "d_lava001", 3897.764160f, 968.982788f, 2306.562256f, -1492.043335f, -199.718567f, 250f); // North Northeast flat (connects at junction)

            
            // AddLiquidPlane(ZoneLiquidType.Magma, "d_lava001", 2310.685791f, -1444.841431f, 2298.043701f, -1491.484497f, -194.311005f, -199.243347f, ZoneLiquidSlantType.SouthHighNorthLow, 250f); // North Northeast, climb south to dragon head
            ...
            // AddLiquidPlaneZLevel(ZoneLiquidType.Magma, "d_lava001", 3183.667236f, 1472.633911f, 1208.061401f, 508.424438f, -199.718567f, 250f); // North from big pool, flat

            
            // AddLiquidPlane(ZoneLiquidType.Magma, "d_lava001", 1138.029541f, 553.655151f, 1120.569214f, 515.174255f, -230.343185f, -249.409698f, ZoneLiquidSlantType.NorthHighSouthLow, 250f); // Big pool into north river
            ...
            // AddLiquidPlane(ZoneLiquidType.Magma, "d_lava001", 1506.949585f, 4497.075684f, 1418.387207f, 4482.598145f, -190.995438f, -199.722076f, ZoneLiquidSlantType.WestHighEastLow, 250f); // Isolated Northwest, west climb (lowest to highest, heading west then south)
            ...
            // AddLiquidPlane(ZoneLiquidType.Magma, "d_lava001", 1579.358765f, 3369.519775f, 1567.883179f, 3306.472412f, -192.043564f, -199.722076f, ZoneLiquidSlantType.NorthHighSouthLow, 250f); // Isolated northwest, north climb (lowest to highest)
            ...
            // AddLiquidPlaneZLevel(ZoneLiquidType.Magma, "d_lava001", 1804.764771f, 4485.881836f, 1028.035400f, 2160.111816f, -199.718567f, 250f); // Isolated northwest, flat bottom

            
            // AddLiquidPlane(ZoneLiquidType.Magma, "d_lava001", 185.356033f, 1632.411011f, 146.063797f, 1612.303955f, -232.347137f, -249.409622f, ZoneLiquidSlantType.WestHighEastLow, 250f); // West from middle pool, north incline westward
            ...
            // AddLiquidPlane(ZoneLiquidType.Magma, "d_lava001", -228.366333f, 1618.229980f, -264.387482f, 1610.473633f, -243.045746f, -249.409546f, ZoneLiquidSlantType.WestHighEastLow, 250f); // West from middle pool, south incline westward
            ...
            // AddLiquidPlaneZLevel(ZoneLiquidType.Magma, "d_lava001", 297.959351f, 2960.479248f, -525.005676f, 1717.256104f, -199.718567f, 250f); // West from middle pool, flat area

            
            // AddLiquidPlane(ZoneLiquidType.Magma, "d_lava001", -135.864883f, 2956.430176f, -199.925705f, 2941.139160f, -190.906799f, -199.253036f, ZoneLiquidSlantType.WestHighEastLow, 250f); // West from middle pool, final western area going up west
            ...
            // AddLiquidPlane(ZoneLiquidType.Magma, "d_lava001", 179.462265f, -176.535965f, 113.597397f, -198.304718f, -227.266724f, -249.409698f, ZoneLiquidSlantType.EastHighWestLow, 250f); // East from middle pool, climb east at the start
            ...
            // AddLiquidPlaneZLevel(ZoneLiquidType.Magma, "d_lava001", 200.561615f, -316.720154f, -970.323547f, -3804.597656f, -199.715317f, 250f); // East from middle, large flat area

            
            // AddLiquidPlane(ZoneLiquidType.Magma, "d_lava001", -213.493576f, 154.825516f, -224.230698f, 87.617737f, -239.011703f, -249.409698f, ZoneLiquidSlantType.SouthHighNorthLow, 250f); // South from middle, climb south at the start
            ...
            // AddLiquidPlaneZLevel(ZoneLiquidType.Magma, "d_lava001", -306.983246f, 164.048187f, -526.242371f, 30.712870f, -199.715317f, 250f); // South from middle, large flat
            // AddLiquidPlaneZLevel(ZoneLiquidType.Magma, "d_lava001", -526.142371f, 463.953613f, -3549.526123f, -1719.308960f, -199.715317f, 250f);

            
            // AddLiquidPlane(ZoneLiquidType.Magma, "d_lava001", -3544.243896f, -1644.605713f, -3557.204834f, -1686.366211f, -196.612473f, -199.440613f, ZoneLiquidSlantType.SouthHighNorthLow, 250f); // Southmost, up into dragon head
            ...
            AddDiscardGeometryBox(-6226.796387f, 2464.754883f, 148.686218f, -7040.175293f, 1019.074219f, -517.262451f, "Reduce zone line to burning wood"); // Reduce zone line to burning wood
        }
    }
}
