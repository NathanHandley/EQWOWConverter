...
namespace EQWOWConverter.Zones.Properties
{
    internal class CabilisEastZoneProperties : ZoneProperties
    {
        public CabilisEastZoneProperties() : base()
        {
            ...
            AddDiscardGeometryBox(-352.861359f, 68.610992f, -6.312210f, -522.594238f, -20.493219f, -108.501801f, "Rock and some water below the map"); // Rock and some water below the map
            AddDiscardGeometryBox(-360.150452f, 194.734756f, 135.514343f, -503.430725f, 105.218224f, -43.974831f, "Two out-of-bounds water strips"); // Two out-of-bounds water strips
        }
    }
}
