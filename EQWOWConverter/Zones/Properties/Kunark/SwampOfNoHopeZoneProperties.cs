...
namespace EQWOWConverter.Zones.Properties
{
    internal class SwampOfNoHopeZoneProperties : ZoneProperties
    {
        ...
        {
            AddZoneLineBox("cabeast", -77.081688f, -559.291016f, 0.000000f, ZoneLineOrientationType.West, 2987.374512f, 3344.827637f, 137.718796f, 2941.379639f, 3248.237549f, -34.482761f);
            AddZoneLineBox("cabeast", -181.223022f, -455.999146f, 0.000040f, ZoneLineOrientationType.North, 3244.827637f, 3072.955811f, 137.718994f, 3128.712891f, 2986.207031f, -68.965530f);
            AddZoneLineBox("trakanon", 1571.971069f, 4444.021484f, -280.291809f, ZoneLineOrientationType.North, 2029.501465f, -4403.036133f, 127.860313f, 1757.333618f, -4617.994141f, 27.355209f);
            AddZoneLineBox("firiona", 2799.611572f, 2990.437012f, -81.785332f, ZoneLineOrientationType.South, -3570.572266f, 3672.467773f, 463.980804f, -4000f, 2239.987305f, -150f, "West");
            AddZoneLineBox("firiona", 2821.060059f, -2125.918701f, -59.864441f, ZoneLineOrientationType.South, -2810.122559f, -1689.736694f, 914.994080f, -4110.231934f, -3271.348145f, -115.132233f, "East");
            AddZoneLineBox("fieldofbone", -2631.684326f, 506.494110f, 8.625390f, ZoneLineOrientationType.North, 5372.649414f, 1621.067383f, 491.251678f, 4752.186035f, 601.566467f, -159.590729f);

            
            AddLiquidPlaneZLevel(ZoneLiquidType.Water, "d_spwt01", 4014.024414f, 3982.306152f, -3986.161865f, -4018.020264f, -20.530670f, 500f); // Main water

            
            AddLiquidPlane(ZoneLiquidType.Water, "d_spwt01", 1376.880859f, -2864.697021f, 1262.926880f, -3009.132080f, 14.152580f, -20.462299f, ZoneLiquidSlantType.EastHighWestLow, 250f); // East river and up into the cave
            ...
            AddLiquidPlane(ZoneLiquidType.Water, "d_spwt01", 1207.356934f, -3320.213867f, 1077.192871f, -3349.652100f, 138.418182f, 27.860479f, ZoneLiquidSlantType.EastHighWestLow, 250f); // Small more east waterfall up into the cave
            ...
            AddLiquidPlane(ZoneLiquidType.Water, "d_spwt01", 2183.705078f, -4453.435547f, 1923.547729f, -4644.909668f, 20.937731f, 20.020670f, ZoneLiquidSlantType.SouthHighNorthLow, 250f); // East cave
