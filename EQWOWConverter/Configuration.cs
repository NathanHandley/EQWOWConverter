...
namespace EQWOWConverter
{
    internal class Configuration
    {
        ...
        public static bool GENERATE_TRANSPORTS = false;

        // If true, quests are generated
        public static bool GENERATE_QUESTS = false;

        // If true, generate and copy maps / minimaps
        public static bool GENERATE_WORLDMAPS = false;
        ...
        public static List<string> GENERATE_ONLY_LISTED_ZONE_SHORTNAMES = new List<string>() { "freporte" };
