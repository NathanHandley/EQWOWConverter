...
namespace EQWOWConverter
{
    internal class Configuration
    {
        ...
        public static int CONFIGONLY_CORE_MOD_VERSION = 108;
        ...
        // Stats that are above the maximum of a range will have this value multiplied to the overage to avoid extremely high values
        public static float ITEM_STATS_OVERFLOW_MULTIPLIER = 0.5f;
        ...
        public static int CLASSAURA_MAGICIAN_OWNER_CRIT_MAX_STACKS = 5;
        public static int CLASSAURA_MAGICIAN_OWNER_CRIT_DURATION_IN_MS = 30000;
        public static int CLASSAURA_MAGICIAN_DETONATE_SUMMONED_SPELL_ICON_EQ_ID = 15;
        ...
        public static int CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_SPELL_ICON_EQ_ID = 7;
        public static int CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_COOLDOWN_IN_MS = 120000;
        public static int CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_MAX_DISTANCE_IN_YARDS = 100;
        public static int CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_SPELL_VISUAL_ID = 10694; // SpellVisual.dbc id of Demonic Circle: Teleport (spell 48020)
        ...
        public static int CLASSAURA_CLERIC_CADENCE_REDUCTION_PERCENT = 25;
        ...
        public static int CLASSAURA_DRUID_DIRECT_HEAL_REGEN_PERCENT = 15;
        ...
        public static int CLASSAURA_DRUID_NATURES_BALANCE_DAMAGE_PERCENT_PER_STACK = 10;
        public static int CLASSAURA_DRUID_NATURES_BALANCE_MAX_STACKS = 10;
        public static int CLASSAURA_DRUID_NATURES_BALANCE_DURATION_IN_MS = 20000;
        public static int CLASSAURA_DRUID_NATURES_BALANCE_MIN_BASE_CAST_TIME_IN_MS = 500;
        ...
        public static int CLASSAURA_DRUID_ENTANGLE_STRIKE_DURATION_IN_MS = 15000;
        public static int CLASSAURA_DRUID_ENTANGLE_STRIKE_SPELL_ICON_EQ_ID = 16;
        ...
        public static void SaveConfiguration()
        {
            ...
            OutputVariableToConfig("ITEM_STATS_OVERFLOW_MULTIPLIER", ITEM_STATS_OVERFLOW_MULTIPLIER, "Stats that are above the maximum of a range will have this value multiplied to the overage to avoid extremely high values");
            ...
            OutputVariableToConfig("CLASSAURA_MAGICIAN_DETONATE_SUMMONED_SPELL_ICON_EQ_ID", CLASSAURA_MAGICIAN_DETONATE_SUMMONED_SPELL_ICON_EQ_ID, "", false);
            ...
            OutputVariableToConfig("CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_COOLDOWN_IN_MS", CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_COOLDOWN_IN_MS, "", false);
            OutputVariableToConfig("CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_MAX_DISTANCE_IN_YARDS", CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_MAX_DISTANCE_IN_YARDS, "", false);
            OutputVariableToConfig("CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_SPELL_VISUAL_ID", CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_SPELL_VISUAL_ID, "", false);
            ...
            OutputVariableToConfig("CLASSAURA_DRUID_NATURES_BALANCE_DAMAGE_PERCENT_PER_STACK", CLASSAURA_DRUID_NATURES_BALANCE_DAMAGE_PERCENT_PER_STACK, "", false);
            OutputVariableToConfig("CLASSAURA_DRUID_NATURES_BALANCE_MAX_STACKS", CLASSAURA_DRUID_NATURES_BALANCE_MAX_STACKS, "", false);
            OutputVariableToConfig("CLASSAURA_DRUID_NATURES_BALANCE_DURATION_IN_MS", CLASSAURA_DRUID_NATURES_BALANCE_DURATION_IN_MS, "", false);
            OutputVariableToConfig("CLASSAURA_DRUID_NATURES_BALANCE_MIN_BASE_CAST_TIME_IN_MS", CLASSAURA_DRUID_NATURES_BALANCE_MIN_BASE_CAST_TIME_IN_MS, "", false);
            ...
            OutputVariableToConfig("CLASSAURA_DRUID_ENTANGLE_STRIKE_DURATION_IN_MS", CLASSAURA_DRUID_ENTANGLE_STRIKE_DURATION_IN_MS, "", false);
        ...
        public static void LoadConfiguration()
        {
            ...
            ITEM_STATS_OVERFLOW_MULTIPLIER = ReadVariableFromConfigString("ITEM_STATS_OVERFLOW_MULTIPLIER", configValuesByVariableName, ITEM_STATS_OVERFLOW_MULTIPLIER);
            ...
            CLASSAURA_SHADOWKNIGHT_SPELL_POWER_FROM_ATTACK_POWER_PERCENT = ReadVariableFromConfigString("CLASSAURA_SHADOWKNIGHT_SPELL_POWER_FROM_ATTACK_POWER_PERCENT", configValuesByVariableName, CLASSAURA_SHADOWKNIGHT_SPELL_POWER_FROM_ATTACK_POWER_PERCENT);
            ...
            CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_SPELL_ICON_EQ_ID = ReadVariableFromConfigString("CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_SPELL_ICON_EQ_ID", configValuesByVariableName, CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_SPELL_ICON_EQ_ID);
            CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_DAMAGE_TAKEN_STORED_PERCENT = ReadVariableFromConfigString("CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_DAMAGE_TAKEN_STORED_PERCENT", configValuesByVariableName, CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_DAMAGE_TAKEN_STORED_PERCENT);
            CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_MAX_HEALTH_PERCENT = ReadVariableFromConfigString("CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_MAX_HEALTH_PERCENT", configValuesByVariableName, CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_MAX_HEALTH_PERCENT);
            CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_STORE_DURATION_IN_MS = ReadVariableFromConfigString("CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_STORE_DURATION_IN_MS", configValuesByVariableName, CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_STORE_DURATION_IN_MS);
            CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_COOLDOWN_IN_MS = ReadVariableFromConfigString("CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_COOLDOWN_IN_MS", configValuesByVariableName, CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_COOLDOWN_IN_MS);
            CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_RANGE = ReadVariableFromConfigString("CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_RANGE", configValuesByVariableName, CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_RANGE);
            CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_EQ_VISUAL_EFFECT_INDEX = ReadVariableFromConfigString("CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_EQ_VISUAL_EFFECT_INDEX", configValuesByVariableName, CLASSAURA_SHADOWKNIGHT_BLOOD_DEBT_EQ_VISUAL_EFFECT_INDEX);
            ...
            CLASSAURA_MAGICIAN_DETONATE_SUMMONED_SPELL_ICON_EQ_ID = ReadVariableFromConfigString("CLASSAURA_MAGICIAN_DETONATE_SUMMONED_SPELL_ICON_EQ_ID", configValuesByVariableName, CLASSAURA_MAGICIAN_DETONATE_SUMMONED_SPELL_ICON_EQ_ID);
            ...
            CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_COOLDOWN_IN_MS = ReadVariableFromConfigString("CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_COOLDOWN_IN_MS", configValuesByVariableName, CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_COOLDOWN_IN_MS);
            CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_MAX_DISTANCE_IN_YARDS = ReadVariableFromConfigString("CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_MAX_DISTANCE_IN_YARDS", configValuesByVariableName, CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_MAX_DISTANCE_IN_YARDS);
            CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_SPELL_VISUAL_ID = ReadVariableFromConfigString("CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_SPELL_VISUAL_ID", configValuesByVariableName, CLASSAURA_NECROMANCER_SHADOW_EXCHANGE_SPELL_VISUAL_ID);
            ...
            CLASSAURA_DRUID_NATURES_BALANCE_DAMAGE_PERCENT_PER_STACK = ReadVariableFromConfigString("CLASSAURA_DRUID_NATURES_BALANCE_DAMAGE_PERCENT_PER_STACK", configValuesByVariableName, CLASSAURA_DRUID_NATURES_BALANCE_DAMAGE_PERCENT_PER_STACK);
            CLASSAURA_DRUID_NATURES_BALANCE_MAX_STACKS = ReadVariableFromConfigString("CLASSAURA_DRUID_NATURES_BALANCE_MAX_STACKS", configValuesByVariableName, CLASSAURA_DRUID_NATURES_BALANCE_MAX_STACKS);
            CLASSAURA_DRUID_NATURES_BALANCE_DURATION_IN_MS = ReadVariableFromConfigString("CLASSAURA_DRUID_NATURES_BALANCE_DURATION_IN_MS", configValuesByVariableName, CLASSAURA_DRUID_NATURES_BALANCE_DURATION_IN_MS);
            CLASSAURA_DRUID_NATURES_BALANCE_MIN_BASE_CAST_TIME_IN_MS = ReadVariableFromConfigString("CLASSAURA_DRUID_NATURES_BALANCE_MIN_BASE_CAST_TIME_IN_MS", configValuesByVariableName, CLASSAURA_DRUID_NATURES_BALANCE_MIN_BASE_CAST_TIME_IN_MS);
            ...
            CLASSAURA_DRUID_ENTANGLE_STRIKE_DURATION_IN_MS = ReadVariableFromConfigString("CLASSAURA_DRUID_ENTANGLE_STRIKE_DURATION_IN_MS", configValuesByVariableName, CLASSAURA_DRUID_ENTANGLE_STRIKE_DURATION_IN_MS);
