...
namespace EQWOWConverter
{
    internal class Configuration
    {
        ...
        public static readonly int CONFIG_SPELLS_GATE_CASTER_LEARN_LEVEL = 4; // Set to 4 or 6 to be more like EQ
        public static readonly int CONFIG_SPELLS_GATE_MELEE_LEARN_LEVEL = -1; // Set to -1 to be like EQ (melee can't learn it)
        public static readonly int CONFIG_SPELLS_GATE_SPELL_LEARN_COST = 100;
        public static readonly int CONFIG_SPELLS_BIND_CASTER_LEARN_LEVEL = 1; // Set to 12 or 14 to be more like EQ
        public static readonly int CONFIG_SPELLS_BIND_MELEE_LEARN_LEVEL = -1; // Set to -1 to be like EQ (melee can't learn it)
        ...
        public static readonly int CONFIG_SQL_CREATURETEMPLATE_ENTRY_LOW = 45000;
        public static readonly int CONFIG_SQL_CREATURETEMPLATE_ENTRY_HIGH = 60000;
        ...
        public static readonly int CONFIG_SQL_NPCTRAINER_ID_END = 211000;
