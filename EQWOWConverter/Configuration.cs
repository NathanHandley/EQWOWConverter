...
namespace EQWOWConverter
{
    internal class Configuration
    {
        ...
        public static float CREATURE_STAT_MOD_AVGDMG_ADD = 0.4f;
        public static float CREATURE_STAT_MOD_AVGDMG_MIN = 1f;
        public static float CREATURE_STAT_MOD_AVGDMG_MAX_NORMAL = 2f;
        public static float CREATURE_STAT_MOD_AVGDMG_MAX_RARE = 2f;
