    ...
    internal class CreatureTemplateModelSQL : SQLFile
    {
        public override string DeleteRowSQL()
        {
            ...
            if (Configuration.CONFIGONLY_CREATURE_SPAWN_AND_WAYPOINT_DEBUG_MODE == true)
                sb.AppendLine("DELETE FROM creature_template_model WHERE `CreatureID` >= " + Configuration.CONFIGONLY_SQL_CREATURETEMPLATE_DEBUG_ENTRY_LOW.ToString() + " AND `CreatureID` <= " + Configuration.CONFIGONLY_SQL_CREATURETEMPLATE_DEBUG_ENTRY_HIGH + ";");
