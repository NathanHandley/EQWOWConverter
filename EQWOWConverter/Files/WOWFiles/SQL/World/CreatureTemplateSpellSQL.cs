...
namespace EQWOWConverter.WOWFiles
{
    internal class CreatureTemplateSpellSQL : SQLFile
    {
        ...
        {
            return "DELETE FROM creature_template_spell WHERE `Spell` >= " + Configuration.DBCID_SPELL_ID_START.ToString() + " AND `Spell` <= " + Configuration.DBCID_SPELL_ID_GENERATED_START + ";";
        }
