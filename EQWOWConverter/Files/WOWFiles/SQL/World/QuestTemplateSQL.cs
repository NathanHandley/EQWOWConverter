...
namespace EQWOWConverter.WOWFiles
{
    internal class QuestTemplateSQL : SQLFile
    {
        ...
        public void AddRow(QuestTemplate questTemplate, int questID, string questName)
        {
            ...
            newRow.AddInt("RewardItem1", questTemplate.RewardItems.Count > 0 ? questTemplate.RewardItems[0].itemIDWOW : 0);
            newRow.AddInt("RewardAmount1", questTemplate.RewardItems.Count > 0 ? questTemplate.RewardItems[0].itemCount : 0);
            newRow.AddInt("RewardItem2", questTemplate.RewardItems.Count > 1 ? questTemplate.RewardItems[1].itemIDWOW : 0);
            newRow.AddInt("RewardAmount2", questTemplate.RewardItems.Count > 1 ? questTemplate.RewardItems[1].itemCount : 0);
            newRow.AddInt("RewardItem3", questTemplate.RewardItems.Count > 2 ? questTemplate.RewardItems[2].itemIDWOW : 0);
            newRow.AddInt("RewardAmount3", questTemplate.RewardItems.Count > 2 ? questTemplate.RewardItems[2].itemCount : 0);
            newRow.AddInt("RewardItem4", questTemplate.RewardItems.Count > 3 ? questTemplate.RewardItems[3].itemIDWOW : 0);
            newRow.AddInt("RewardAmount4", questTemplate.RewardItems.Count > 3 ? questTemplate.RewardItems[3].itemCount : 0);
            ...
            newRow.AddInt("RequiredItemId1", questTemplate.RequiredItems.Count > 0 ? questTemplate.RequiredItems[0].itemIDWOW : 0);
            newRow.AddInt("RequiredItemId2", questTemplate.RequiredItems.Count > 1 ? questTemplate.RequiredItems[1].itemIDWOW : 0);
            newRow.AddInt("RequiredItemId3", questTemplate.RequiredItems.Count > 2 ? questTemplate.RequiredItems[2].itemIDWOW : 0);
            newRow.AddInt("RequiredItemId4", questTemplate.RequiredItems.Count > 3 ? questTemplate.RequiredItems[3].itemIDWOW : 0);
            newRow.AddInt("RequiredItemId5", questTemplate.RequiredItems.Count > 4 ? questTemplate.RequiredItems[4].itemIDWOW : 0);
            newRow.AddInt("RequiredItemId6", questTemplate.RequiredItems.Count > 5 ? questTemplate.RequiredItems[5].itemIDWOW : 0);
            newRow.AddInt("RequiredItemCount1", questTemplate.RequiredItems.Count > 0 ? questTemplate.RequiredItems[0].itemCount : 0);
            newRow.AddInt("RequiredItemCount2", questTemplate.RequiredItems.Count > 1 ? questTemplate.RequiredItems[1].itemCount : 0);
            newRow.AddInt("RequiredItemCount3", questTemplate.RequiredItems.Count > 2 ? questTemplate.RequiredItems[2].itemCount : 0);
            newRow.AddInt("RequiredItemCount4", questTemplate.RequiredItems.Count > 3 ? questTemplate.RequiredItems[3].itemCount : 0);
            newRow.AddInt("RequiredItemCount5", questTemplate.RequiredItems.Count > 4 ? questTemplate.RequiredItems[4].itemCount : 0);
            newRow.AddInt("RequiredItemCount6", questTemplate.RequiredItems.Count > 5 ? questTemplate.RequiredItems[5].itemCount : 0);
