...
namespace EQWOWConverter.WOWFiles
{
    internal class QuestTemplateSQL : SQLFile
    {
        ...
        public void AddRow(QuestTemplate questTemplate, int questID, string questName)
        {
            ...
            newRow.AddInt("RequiredItemId1", questTemplate.RequiredItems[0].itemIDWOW);
            newRow.AddInt("RequiredItemId2", questTemplate.RequiredItems[1].itemIDWOW);
            newRow.AddInt("RequiredItemId3", questTemplate.RequiredItems[2].itemIDWOW);
            newRow.AddInt("RequiredItemId4", questTemplate.RequiredItems[3].itemIDWOW);
            newRow.AddInt("RequiredItemId5", questTemplate.RequiredItems[4].itemIDWOW);
            newRow.AddInt("RequiredItemId6", questTemplate.RequiredItems[5].itemIDWOW);
            newRow.AddInt("RequiredItemCount1", questTemplate.RequiredItems[0].itemCount);
            newRow.AddInt("RequiredItemCount2", questTemplate.RequiredItems[1].itemCount);
            newRow.AddInt("RequiredItemCount3", questTemplate.RequiredItems[2].itemCount);
            newRow.AddInt("RequiredItemCount4", questTemplate.RequiredItems[3].itemCount);
            newRow.AddInt("RequiredItemCount5", questTemplate.RequiredItems[4].itemCount);
            newRow.AddInt("RequiredItemCount6", questTemplate.RequiredItems[5].itemCount);
