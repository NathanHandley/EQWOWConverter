...
namespace EQWOWConverter.WOWFiles
{
    internal class ModEverquestCreatureKillSpawnSQL : SQLFile
    {
        ...
        public void AddRow(int id, int triggerCreatureTemplateID, int mapID, int actionType, int targetCreatureTemplateID,
            ...
            int triggerMinLevel, int triggerMaxLevel, string comment)
        {
