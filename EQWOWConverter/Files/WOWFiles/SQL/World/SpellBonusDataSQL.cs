...
namespace EQWOWConverter.WOWFiles
{
    internal class SpellBonusDataSQL : SQLFile
    {
        ...
        public void AddRow(int spellTemplateID, float directBonus, float dotBonus, string comment)
        {
            SQLRow newRow = new SQLRow();
            newRow.AddInt("entry", spellTemplateID);
            newRow.AddFloat("direct_bonus", directBonus);
            newRow.AddFloat("dot_bonus", dotBonus);
