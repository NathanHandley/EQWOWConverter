...
namespace EQWOWConverter.WOWFiles
{
    internal class PoolPoolSQL : SQLFile
    {
        ...
        {
            return "DELETE FROM pool_pool WHERE pool_id >= " + Configuration.SQL_POOL_TEMPLATE_ID_START.ToString() + " AND pool_id <= " + Configuration.SQL_POOL_TEMPLATE_ID_END.ToString() + ";";
        }
