...
namespace EQWOWConverter.WOWFiles
{
    internal class CreatureModelDataDBC : DBCFile
    {
        public void AddRow(int id, int soundId, string modelName)
        {
            ...
            newRow.AddFloat(-2); // GeoBoxMinX, Min vert X
            newRow.AddFloat(-2); // GeoBoxMinY, Min vert Y
            newRow.AddFloat(-2); // GeoBoxMinZ, Min vert Z
            newRow.AddFloat(2); // GeoBoxMaxX, Max vert X
            newRow.AddFloat(2); // GeoBoxMaxY, Max vert Y
            newRow.AddFloat(2); // GeoBoxMaxZ, Max vert Z
