    ...
    internal class LightIntBandDBC : DBCFile
    {
        ...
        public void AddRows(ZoneEnvironmentSettings.ZoneEnvironmentParameters environmentParameters)
        {
            ...
            foreach (LightRow lightRow in lightRows)
            {
                ...
                newRow.AddInt32(lightRow.Id);
                newRow.AddInt32(lightRow.NumOfTimeSlices);
                newRow.AddInt32(lightRow.TimeValues[0]);
                newRow.AddInt32(lightRow.TimeValues[1]);
                newRow.AddInt32(lightRow.TimeValues[2]);
                newRow.AddInt32(lightRow.TimeValues[3]);
                newRow.AddInt32(lightRow.TimeValues[4]);
                newRow.AddInt32(lightRow.TimeValues[5]);
                newRow.AddInt32(lightRow.TimeValues[6]);
                newRow.AddInt32(lightRow.TimeValues[7]);
                newRow.AddInt32(lightRow.TimeValues[8]);
                newRow.AddInt32(lightRow.TimeValues[9]);
                newRow.AddInt32(lightRow.TimeValues[10]);
                newRow.AddInt32(lightRow.TimeValues[11]);
                newRow.AddInt32(lightRow.TimeValues[12]);
                newRow.AddInt32(lightRow.TimeValues[13]);
                newRow.AddInt32(lightRow.TimeValues[14]);
                newRow.AddInt32(lightRow.TimeValues[15]);
                newRow.AddInt32(lightRow.DataValues[0]);
                newRow.AddInt32(lightRow.DataValues[1]);
                newRow.AddInt32(lightRow.DataValues[2]);
                newRow.AddInt32(lightRow.DataValues[3]);
                newRow.AddInt32(lightRow.DataValues[4]);
                newRow.AddInt32(lightRow.DataValues[5]);
                newRow.AddInt32(lightRow.DataValues[6]);
                newRow.AddInt32(lightRow.DataValues[7]);
                newRow.AddInt32(lightRow.DataValues[8]);
                newRow.AddInt32(lightRow.DataValues[9]);
                newRow.AddInt32(lightRow.DataValues[10]);
                newRow.AddInt32(lightRow.DataValues[11]);
                newRow.AddInt32(lightRow.DataValues[12]);
                newRow.AddInt32(lightRow.DataValues[13]);
                newRow.AddInt32(lightRow.DataValues[14]);
                newRow.AddInt32(lightRow.DataValues[15]);
                Rows.Add(newRow);
            }
        }
    }
