...
namespace EQWOWConverter.WOWFiles
{
    ...
    {
        static private int CUR_DBCID = Configuration.DBCID_SPELLRANGE_ID_START;
        static private readonly object SpellRangeDBCLock = new object();
        ...
        static public int GenerateDBCID()
        {
