...
namespace EQWOWConverter.EQFiles
{
    ...
    internal class EQSpellsEFF
    {
        internal class SectionData
        {
            ...
            public int[] EmissionTypeIDs = new int[3]; // -1 = None, 0 = Hands, 1 = reverse sphere?, 2 = Sphere around player, 3 = Disc on the ground, 4 = Column from the ground, 5 = Disc at the player center.  Note: 5 also gives a 2 and a 3 emitter.
