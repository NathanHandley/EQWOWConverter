...
namespace EQWOWConverter.EQFiles
{
    internal class EQMaterialList
    {
        ...
        public void LoadForInvisibleMan()
        {
            ...
            MaterialsByTextureVariation[0].Add(new Material("00", "00", 0, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("01", "01", 1, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("02", "02", 2, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("03", "03", 3, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("04", "04", 4, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("05", "05", 5, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("06", "06", 6, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("07", "07", 7, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("08", "08", 8, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("09", "09", 9, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("10", "10", 10, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("11", "11", 11, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("12", "12", 12, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("13", "13", 13, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("14", "14", 14, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("15", "15", 15, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            MaterialsByTextureVariation[0].Add(new Material("16", "16", 16, MaterialType.TransparentAdditive, new List<string> { "clear" }, 0, 256, 256, false, false));
            ...
            for (int variationIndex = 0; variationIndex < variationCount; ++variationIndex)
            {
                foreach (string inputRow in inputRows)
                {
                    ...
                    Material newMaterial = new Material(name, name, index, materialType, sourceTextureNameArray, animationDelayInMS,
                        sourceTextureWidth, sourceTextureHeight, false, false);
