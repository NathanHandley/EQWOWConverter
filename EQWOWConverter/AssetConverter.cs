    ...
    internal class AssetConverter
    {
        ...
        public void GenerateCustomSpells(ref List<SpellTemplate> spellTemplates)
        {
            ...
            if (Configuration.SPELLS_GATE_TETHER_ENABLED == true)
            {
                ...
                gateSpellTemplate.WOWSpellEffects.Add(new SpellEffectWOW(SpellWOWEffectType.ApplyAura, SpellWOWAuraType.Dummy, 0, 0, 0, 0, (int)SpellAuraDummyType.Gate, 0));
            }
            else
                gateSpellTemplate.WOWSpellEffects.Add(new SpellEffectWOW(SpellWOWEffectType.Dummy, SpellWOWAuraType.None, 0, 0, 0, 0, (int)SpellAuraDummyType.Gate, 0));
            ...
            bindAffinitySelfSpellTemplate.WOWSpellEffects.Add(new SpellEffectWOW(SpellWOWEffectType.Dummy, SpellWOWAuraType.Dummy, 0, 0, 0, 0, (int)SpellAuraDummyType.BindSelf, 0));
